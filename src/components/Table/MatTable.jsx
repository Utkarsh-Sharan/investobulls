        ...
        <table className='border-collapse'>
            <thead>
                <tr className='border-b-2 dark:border-gray-400'>
                    ...
                    <th className='px-4 py-2'>Deviation from Pivots</th>
                    <th className='px-4 py-2'>TODAY'S RANGE</th>
                    <th className='px-4 py-2'>OHL</th>
                </tr>
            </thead>
                    ...
                    >
                        <td className='px-4 py-2'>
                            <div className='flex items-center gap-2'>
                                <div className='border-2 dark:border-gray-400 w-7 rounded-full bg-gray-300 dark:bg-gray-500
                                text-xl text-center'>
                                    {data.symbol[0]}
                                </div>
                                <p>{data.symbol}</p>
